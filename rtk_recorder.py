...
def main(argv):
    ...
    # record_file = log_dir + "/garage4_length.csv"
    # record_file = log_dir + "/complex_left.csv"
    # record_file = log_dir + "/big_cycle.csv"
    # record_file = log_dir + "/Cross3.csv"
    # record_file = log_dir + "/garage4_length_dns.csv"
    record_file = log_dir + "/offline_test.csv"
